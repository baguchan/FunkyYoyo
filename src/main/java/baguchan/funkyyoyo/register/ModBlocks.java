...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> YOYO_TABLE = register("yoyo_table", () -> new YoyoTableBlock(BlockBehaviour.Properties.of(Material.WOOD).strength(0.5F).sound(SoundType.WOOD)));
