...
public class ModItems {
    ...
    public static final RegistryObject<Item> WOOD_PARTS = ITEMS.register("wood_parts", () -> new YoyoSideItem((new Item.Properties().stacksTo(16)), new ResourceLocation(FunkyYoyo.MODID, "wood")));
